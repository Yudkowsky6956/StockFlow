...
media_type_map = {
    "photos": t("info.scripts.show_sales_data.photos"),
    "videos": t("info.scripts.show_sales_data.videos"),
    "vectors": t("info.scripts.show_sales_data.vectors"),
    "illustrations": t("info.scripts.show_sales_data.illustrations")
}
media_ai_map = {
    True: " ИИ",
    False: ""
...
def show_sales_infographics():
    ...
    logger.success(f"{t("info.scripts.starting_script")}: {t("info.scripts.show_sales_infographics.name")}")
